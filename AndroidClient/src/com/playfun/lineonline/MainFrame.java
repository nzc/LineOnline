...
public class MainFrame extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.addTab(mTabHost.newTabSpec("3").setIndicator("广场"), CommentFragment.class, null);
        mAdapter.addTab(mTabHost.newTabSpec("4").setIndicator("我的"), ShareFragment.class, null);
